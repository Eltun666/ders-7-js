...
//     let city = users.map((item) => item.address.city);
//     let newcity = (city);

//     for (let i = 0; i < newcity.length; i++) {
//         let currentCity = newcity[i]; 
//         console.log(`Şəhərler: ${currentCity}`);

//         for (let j = 0; j < users.length; j++) {
//             if (currentCity === users[j].address.city) {
//                 console.log(users[j]);
//             }
//         }
//     }
...
// const role = () => {
//     let resalt = users.filter((item) => item.role == "user")
//     console.log(resalt);
    
//     let resalt1 = users.filter((item) => item.role == "admin")
//     console.log(resalt1);

//     let resalt2 = users.filter((item) => item.role == "moderator")
//     console.log(resalt2);
...
// const department = () => {
//     let resalt = users.filter((item) => item.company.department == "Accounting")
//     console.log(resalt);   
// }
...
// const emaill = () => {
//     let resalt = users.filter((item) => item.email[item.email.length - 9] == "g")
//     console.log(resalt);
